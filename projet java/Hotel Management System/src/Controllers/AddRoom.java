...
public class AddRoom extends JFrame implements ActionListener{
	...
	ImageIcon i1 = null;
    java.net.URL imgURL = getClass().getClassLoader().getResource("hotel/management/system/icons/room.png");

    if (imgURL != null) {
        i1 = new ImageIcon(imgURL);
    } else {
        System.err.println("Couldn't find file: hotel/management/system/icons/room.png");
    }
